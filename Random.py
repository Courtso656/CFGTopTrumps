...
if format == "Single Round":
    ...
    while restart == "yes" and format == "Build a Team":
        pokedex= []
        pokenumber= []
        player_pokemon1 = input("What pokemon would you like in slot 1? (1-807)" )
        pokenumber.append(player_pokemon1)
        url = 'https://pokeapi.co/api/v2/pokemon/{}/'.format(player_pokemon1)
        response = requests.get(url)
        p_pokemon = response.json()
        pokedex.append(p_pokemon['name'])
        player_pokemon1 = input("What pokemon would you like in slot 2? (1-807)" )
        pokenumber.append(player_pokemon1)
        url = 'https://pokeapi.co/api/v2/pokemon/{}/'.format(player_pokemon1)
        response = requests.get(url)
        p_pokemon = response.json()
        pokedex.append(p_pokemon['name'])
        player_pokemon1 = input("What pokemon would you like in slot 3? (1-807)" )
        pokenumber.append(player_pokemon1)
        url = 'https://pokeapi.co/api/v2/pokemon/{}/'.format(player_pokemon1)
        response = requests.get(url)
        p_pokemon = response.json()
        pokedex.append(p_pokemon['name'])
        player_pokemon1 = input("What pokemon would you like in slot 4? (1-807)" )
        pokenumber.append(player_pokemon1)
        url = 'https://pokeapi.co/api/v2/pokemon/{}/'.format(player_pokemon1)
        response = requests.get(url)
        p_pokemon = response.json()
        pokedex.append(p_pokemon['name'])
        player_pokemon1 = input("What pokemon would you like in slot 5? (1-807)" )
        pokenumber.append(player_pokemon1)
        url = 'https://pokeapi.co/api/v2/pokemon/{}/'.format(player_pokemon1)
        response = requests.get(url)
        p_pokemon = response.json()
        pokedex.append(p_pokemon['name'])
        player_pokemon1 = input("What pokemon would you like in slot 6? (1-807)" )
        pokenumber.append(player_pokemon1)
        url = 'https://pokeapi.co/api/v2/pokemon/{}/'.format(player_pokemon1)
        response = requests.get(url)
        p_pokemon = response.json()
        ...
        while restart =="yes" and total_rounds < 6:
            ...
            computer_pokemon = random.randint(1, 807)
            url = 'https://pokeapi.co/api/v2/pokemon/{}/'.format(computer_pokemon)
            response = requests.get(url)
            c_pokemon = response.json()
            stat_dic = c_pokemon['stats']
